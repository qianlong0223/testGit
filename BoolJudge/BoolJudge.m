...
/** 挤掉线退出到登录页面 */
+(void)ClearnDataAndRelogin{
    NSString *appDomain = [[NSBundle mainBundle] bundleIdentifier];
    [[NSUserDefaults standardUserDefaults] removePersistentDomainForName:appDomain];
    LoginVC * vc = [[LoginVC alloc]init];
    [kWindow setRootViewController:vc];

}
/** 配置公共的接口参数 */
+(NSMutableDictionary *)configPublicParameter{
    ...
    [format1 setDateFormat:@"MMddyyyy"];
    NSString *dateStr;
    dateStr=[format1 stringFromDate:date];
    
    NSString * tokenString = [NSString stringWithFormat:@"%@%@%@%@",sessionId,userId,@"jdlx",dateStr];
    NSString * Md5_32String = [NSString MD5_32BitEncry:tokenString isUppercase:NO];
    NSMutableDictionary * dic = [[NSMutableDictionary alloc]init];
    [dic setObject:sessionId forKey:@"sessionId"];
    [dic setObject:userId forKey:@"userId"];
    [dic setObject:Md5_32String forKey:@"token"];
    return dic;
}
